...
All named tests are in `tests/test_m5phet_regimes.py`. Main M5PHET runtime output
validation and web acceptance are explicitly external, not marked passed here.
